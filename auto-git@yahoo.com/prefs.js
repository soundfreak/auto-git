...
const SCHEMA_NAME = 'org.gnome.shell.extensions.auto-git';
...
function init() {
	...
	if (localeDir.query_exists(null))
		Gettext.bindtextdomain('auto-git', localeDir.get_path());
}
...
const App = new Lang.Class({
	...
	_init: function() {
		...
		this.field_SETTINGS_REFRESH_RATE = new Gtk.SpinButton({ adjustment: new Gtk.Adjustment({ lower: 1, upper: 60, step_increment: 5 }) });
		...
		this.main.attach(this.field_SETTINGS_REFRESH_RATE, 4, 3, 2, 1);
